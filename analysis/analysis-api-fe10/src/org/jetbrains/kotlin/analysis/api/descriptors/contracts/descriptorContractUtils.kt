...
internal fun EffectDeclaration.effectDeclarationToAnalysisApi(): KtEffectDeclaration = accept(EffectDeclarationToAnalysisApi, Unit)
...
private object EffectDeclarationToAnalysisApi : ContractDescriptionVisitor<KtEffectDeclaration, Unit> {
    ...
    override fun visitCallsEffectDeclaration(callsEffect: CallsEffectDeclaration, data: Unit): KtEffectDeclaration =
        KtCallsEffectDeclaration(callsEffect.variableReference.accept(VariableReferenceToAnalysisApi, data), callsEffect.kind)
