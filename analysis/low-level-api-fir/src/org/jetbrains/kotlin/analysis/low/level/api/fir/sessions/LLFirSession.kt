...
abstract class LLFirSession(
    ...
    fun invalidate() {
        ...
        if (application.isWriteAccessAllowed) {
            ...
            // 100% waterproof, but `LLFirSession.invalidate` is only a workaround for the deeper issues outlined in KT-56503. When session
            // invalidation after exceptions in analysis is not needed anymore, this whole function can be removed as well.
