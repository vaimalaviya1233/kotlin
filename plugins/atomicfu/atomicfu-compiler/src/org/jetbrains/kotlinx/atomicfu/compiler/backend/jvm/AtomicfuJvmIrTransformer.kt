...
private const val CONSTRAINTS_MESSAGE =
    "\nPlease follow these constraints for using atomic properties:\n" +
            "   * Only simple operations directly invoked on atomic variables are supported\n" +
            "       * Do not read references to atomic variables into local variables:\n" +
            "           e.g. this usage is acceptable:\n" +
            "           val top = atomic<Node?>(null)\n" +
            "           top.compareAndSet(null, Node(1)) // ok \n\n" +
            "           and this is not:\n" +
            "           val tmp = top\n" +
            "           tmp.compareAndSet(null, Node(1)) \n" +
