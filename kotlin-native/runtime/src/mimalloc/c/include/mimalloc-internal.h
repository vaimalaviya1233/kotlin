...
void*      _mi_os_alloc(size_t size, mi_stats_t* stats, bool is_internal);           // to allocate thread local data
void       _mi_os_free(void* p, size_t size, mi_stats_t* stats, bool is_internal);   // to free thread local data
