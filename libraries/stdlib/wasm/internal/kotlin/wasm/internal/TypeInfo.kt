...
internal fun getTypeInfoTypeDataByPtr(typeInfoPtr: Int): TypeInfoData {
    ...
    val packageName = array_new_data0<WasmCharArray>(fqNamePtr, fqNameLength).createString()
    val simpleName = array_new_data0<WasmCharArray>(simpleNamePtr, simpleNameLength).createString()
