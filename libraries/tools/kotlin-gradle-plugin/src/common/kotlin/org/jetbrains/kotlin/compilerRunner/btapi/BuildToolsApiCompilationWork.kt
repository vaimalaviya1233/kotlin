...
internal abstract class BuildToolsApiCompilationWork : WorkAction<BuildToolsApiCompilationWork.BuildToolsApiCompilationParameters> {
    ...
    override fun execute() {
        ...
        val executionConfig = compilationService.generateCompilerExecutionStrategyConfig().apply {
            useInProcessStrategy()
        }
        val jvmCompilationConfig = compilationService.generateJvmCompilationConfig()
