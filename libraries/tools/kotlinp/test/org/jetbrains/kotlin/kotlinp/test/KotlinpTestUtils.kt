    ...
    compile(file, disposable, tmpdir, useK2) { outputFile ->
        when (outputFile.extension) {
            ...
            "class" -> {
                ...
                val classFile3 = KotlinClassMetadata.read(transformClassFileWithNodes(classFile))
...
private fun transformClassFileWithNodes(classFile: KotlinClassMetadata): Metadata =
    when (classFile) {
        ...
        is KotlinClassMetadata.Unknown -> classFile.annotationData
    }
