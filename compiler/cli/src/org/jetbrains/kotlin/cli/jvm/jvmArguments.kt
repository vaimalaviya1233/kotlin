...
fun CompilerConfiguration.setupJvmSpecificArguments(arguments: K2JVMCompilerArguments) {
    ...
    if (releaseTargetArg != null) {
        ...
        if (value == null || value < 6) {
            ...
            if (!arguments.allowJvmTargetDifferentFromJdkRelease && jvmTargetArg != null && jvmTargetArg != releaseTargetArg) {
    ...
    val jvmTargetValue = if (arguments.allowJvmTargetDifferentFromJdkRelease)
        jvmTargetArg
