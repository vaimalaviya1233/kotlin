...
object IrTree : AbstractTreeBuilder() {
    ...
    private fun descriptor(typeName: String, nullable: Boolean = false) =
        field(
            name = "descriptor",
            type = ClassRef<TypeParameterRef>(TypeKind.Interface, "org.jetbrains.kotlin.descriptors", typeName),
            mutable = false,
            nullable = nullable,
        ) {
            skipInIrFactory()
