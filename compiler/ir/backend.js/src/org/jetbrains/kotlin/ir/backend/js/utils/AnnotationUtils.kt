...
object JsAnnotations {
    ...
    val jsSkipFullReflection = FqName("kotlin.js.JsSkipFullReflection")
...
fun IrAnnotationContainer.couldSkipFullReflection(): Boolean =
    hasAnnotation(JsAnnotations.jsSkipFullReflection)
