...
object DIAGNOSTICS_LIST : DiagnosticList("FirErrors") {
    ...
    val PROPERTIES_AND_ACCESSORS by object : DiagnosticGroup("Properties & accessors") {
        ...
        val MUST_BE_INITIALIZED_OR_FINAL_OR_ABSTRACT_WARNING by error<KtProperty>(PositioningStrategy.DECLARATION_SIGNATURE)
        val MUST_BE_INITIALIZED_OR_BE_FINAL_WARNING by error<KtProperty>(PositioningStrategy.DECLARATION_SIGNATURE)
